...
module Jekyll
  ...
  EXCLUDED_FILES = ["atom.xml","archive.html","categories.html","pages/aca.html","aca.html","toc-kernel.html","toc-android-tutorials.html","sitemap.txt","tags.html","rss.xml"]
